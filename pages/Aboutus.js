  ...
  return (
    ...
    <div className=" bg-black top-[50px] sm:top-[80px] relative  w-full min-h-screen text-white py-16 px-4 sm:px-16 ">
      ...
      <div className='flex flex-col  space-y-10   '>
        ...
        An Electronics and Communication graduate with a passion for web development, I'm currently thriving as a Software Developer Trainee. My expertise spans a wide array of web development technologies, including HTML, Tailwind CSS, JavaScript, ReactJS, and responsive web design. With a drive to create seamless user experiences, I'm eager to contribute my skills and innovative mindset to the ever-evolving world of software development. Let's connect and explore the possibilities together!
        </h3>
